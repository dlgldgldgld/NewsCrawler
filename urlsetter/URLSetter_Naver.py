...
class URLSetter_Naver( URLSetter ) :
    def GetUrlList( self ) -> list :
        temp = list()
        temp.append( urllist('Politic', 'https://news.naver.com/main/main.naver?mode=LSD&mid=shm&sid1=100') )
        temp.append( urllist('Economic', 'https://news.naver.com/main/main.naver?mode=LSD&mid=shm&sid1=101') )
        temp.append( urllist('Social', 'https://news.naver.com/main/main.naver?mode=LSD&mid=shm&sid1=102') )
